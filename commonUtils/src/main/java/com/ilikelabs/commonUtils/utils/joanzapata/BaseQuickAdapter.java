 ...
 */
package com.ilikelabs.commonUtils.utils.joanzapata;
...
public abstract class BaseQuickAdapter<T, H extends BaseAdapterHelper> extends BaseAdapter {
     ...
     * @param layoutResId The layout resource id of each product_brand_list_item.
     */
    ...
    /**
     * Implement this method and use the helper to adapt the view to the given product_brand_list_item.
     * @param helper A fully initialized helper.
     * @param item   The product_brand_list_item that needs to be displayed.
     */
	 ...
	 *
	 * @param position The position of the product_brand_list_item within the adapter's data set of the product_brand_list_item whose view we want.
